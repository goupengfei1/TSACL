...
from utils.cka_tools import compute_cka
...
class Exp_Long_Term_Forecast(Exp_Basic):
    def __init__(self, itr_now, args):
        super(Exp_Long_Term_Forecast, self).__init__(itr_now, args)
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            logs['val_loss'].append(float(vali_loss))
            logs['test_loss'].append(float(test_loss))
        ...
        # json.dump(logs, open(os.path.join(path, 'loss_logs.json'), 'w'))
